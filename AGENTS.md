...
- Let Codex App own subagents, worktrees, diff/Git/PR flows, automations, plugins, skill loading, Computer Use, image generation, and native memories; this repo adds method and governed memory layers on top.

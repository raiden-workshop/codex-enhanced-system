...
source_refs:
  - ../../raw/repos/codex-memory-kit/docs/oh-my-codex-upstream-review-notes.md
related:
...
- Raw copy: [upstream-review-notes](../../raw/repos/codex-memory-kit/docs/oh-my-codex-upstream-review-notes.md)

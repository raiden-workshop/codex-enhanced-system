...
source_refs:
  - ../../raw/repos/codex-memory-kit/docs/oh-my-codex-memory-integration-design.md
related:
...
- Source kind: `design`
- Raw copy: [integration-design](../../raw/repos/codex-memory-kit/docs/oh-my-codex-memory-integration-design.md)

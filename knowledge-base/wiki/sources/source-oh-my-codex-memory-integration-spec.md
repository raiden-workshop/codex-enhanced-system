...
source_refs:
  - ../../raw/repos/codex-memory-kit/docs/oh-my-codex-memory-integration-spec.md
related:
...
- Source kind: `spec`
- Raw copy: [integration-spec](../../raw/repos/codex-memory-kit/docs/oh-my-codex-memory-integration-spec.md)

...
source_refs:
  - ../../raw/repos/codex-memory-kit/docs/oh-my-codex-verification-evidence-gate-design.md
related:
...
- Source kind: `design`
- Raw copy: [verification-evidence-gate-design](../../raw/repos/codex-memory-kit/docs/oh-my-codex-verification-evidence-gate-design.md)

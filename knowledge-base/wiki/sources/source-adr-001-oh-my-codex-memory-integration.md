...
source_refs:
  - ../../raw/repos/codex-memory-kit/docs/adr-001-oh-my-codex-memory-integration.md
related:
...
- Source kind: `adr`
- Raw copy: [adr-001](../../raw/repos/codex-memory-kit/docs/adr-001-oh-my-codex-memory-integration.md)

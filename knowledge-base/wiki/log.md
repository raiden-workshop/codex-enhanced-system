...
- Imported `docs/README.md` into `raw/repos/codex-memory-kit/docs/README.md`
...
- Imported `docs/raiden-lab-repository-map.md` into `raw/repos/codex-memory-kit/docs/raiden-lab-repository-map.md`
...
- Imported `docs/raiden-lab-naming-convention.md` into `raw/repos/codex-memory-kit/docs/raiden-lab-naming-convention.md`
...
- Copied the stable baseline from `<archive-root>/knowledge-base` into `<repo-root>/knowledge-base`
...
- Synced the remaining archived repository files into `raw/repos/codex-memory-kit/`
- Preserved the retained local implementation surface under `raw/repos/codex-memory-kit/src/` and `raw/repos/codex-memory-kit/test/`
- Preserved the exported upstream patch artifacts under `raw/repos/codex-memory-kit/patches/`
